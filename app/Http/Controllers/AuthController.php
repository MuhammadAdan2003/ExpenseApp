...
class AuthController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('Users.Auth.register', compact('countryList', 'currencyCode', 'Currency'));
    }
    ...
    public function register(Request $request)
    {
        try {
            $request->validate([
                ...
                'country'     => 'required',
                'email'     => 'required|email|max:110|unique:users,email',
            ...
            if ($request->hasFile('image')) {
                ...
                $imageName = time() . '_' . uniqid() . '.' . $extension; // unique name
            ...
            User::create([
                ...
                "image"    => $imageName, // Save file name in DB
            ]);
        ...
        try {
            ...
            if (Auth::attempt($cred)) {
                ...
                return response()->json([
                    ...
                    'redirect' => route('dashboard') // send where to go
                ]);
            }
